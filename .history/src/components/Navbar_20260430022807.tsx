      ...
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        <div className="flex items-center gap-10">
          ...
          <div className="hidden lg:flex items-center gap-8 text-sm font-bold uppercase tracking-widest">
            ...
            <NavLink to="/cars" className={({isActive}) => isActive ? 'text-primary' : 'text-muted-foreground hover:text-primary transition-colors'}>
              {t('cars') || 'CARS'}
            </NavLink>
            <NavLink to="/journals" className={({isActive}) => isActive ? 'text-primary' : 'text-muted-foreground hover:text-primary transition-colors'}>
              {t('journal')}
            </NavLink>
          </div>
        </div>
            ...
            <SheetContent side="right" className="w-[300px] sm:w-[400px]">
              ...
              <div className="flex flex-col gap-6 mt-10">
                <div className="flex flex-col gap-4">
                  ...
                  <NavLink to="/cars" className="text-xl font-black uppercase tracking-widest hover:text-primary transition-colors">
                    {t('cars') || 'CARS'}
                  </NavLink>
                  <NavLink to="/journals" className="text-xl font-black uppercase tracking-widest hover:text-primary transition-colors">
                    {t('journal')}
                  </NavLink>
                  {user && (
