...
export default function BlogDetails() {
  ...
  if (!blog)
    return (
      <div className="container mx-auto p-20 text-center">Post not found.</div>
    );
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative h-[60vh] flex items-end overflow-hidden">
        ...
        <div className="container relative z-10 mx-auto px-4 pb-12">
          <Button
            variant="ghost"
            className="text-white hover:text-primary mb-8 gap-2 font-bold uppercase tracking-widest text-xs"
            onClick={() => navigate("/blog")}
          >
            <ArrowLeft size={16} /> Back to Journal
          </Button>
          <div className="max-w-4xl">
            <span className="text-primary font-black uppercase tracking-[0.3em] text-xs mb-4 inline-block italic px-4 py-1.5 rounded-full bg-primary/10 backdrop-blur-md">
              {blog.category}
            </span>
            <motion.h1
          ...
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-xl dark:prose-invert italic text-muted-foreground leading-relaxed space-y-8">
              ...
              <div className="p-12 bg-muted/30 rounded-[40px] border border-border/50 text-center my-16">
                ...
                <p className="mb-8">
                  Share it with your fellow travelers and start planning your
