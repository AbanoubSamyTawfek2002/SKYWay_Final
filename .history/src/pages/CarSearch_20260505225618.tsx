  ...
  const fetchCars = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch(
        `${import.meta.env.VITE_API_URL}/api/cars?${params.toString()}`,
      );
  ...
  return (
    <div className="bg-muted/10 min-h-[calc(100vh-80px)]">
      ...
      <div className="relative px-4 py-16 md:py-24 overflow-hidden bg-gradient-to-b from-[#F7F8FA] to-[#EDEFF3] dark:from-[#0B0B0B] dark:to-[#111111] border-b border-border/40">
        ...
        <div className="container mx-auto max-w-6xl relative z-10 flex flex-col items-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 font-medium mb-12 text-sm md:text-lg text-center tracking-wide max-w-2xl">
            Compare premium car rental deals from top companies. Experience
            luxury and comfort on your terms.
          </p>

          <form
            onSubmit={handleSearch}
            className="w-full p-4 md:p-6 rounded-[24px] backdrop-blur-[14px] bg-white/80 dark:bg-[rgba(20,20,20,0.75)] border border-black/5 dark:border-white/10 shadow-[0_10px_40px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.4)] flex flex-col gap-4"
          >
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              <div className="md:col-span-4 relative">
                <label className="text-[10px] font-black uppercase tracking-widest text-muted-foreground mb-1 block ml-2">
                  Pick-up Location
                </label>
              ...
              <div className="md:col-span-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                <div className="relative">
                  ...
                  <DatePicker
                    ...
                    inputClassName={cn(
                      "w-full pl-10 pr-4 h-16 rounded-[16px] justify-start text-left text-base font-bold transition-all bg-[#F1F3F6] dark:bg-[rgba(255,255,255,0.05)] border-2 border-transparent focus:border-primary/50 focus:bg-white dark:focus:bg-[rgba(255,255,255,0.1)] focus:shadow-[0_0_15px_rgba(var(--primary),0.1)]",
                      !pickUpDate && "text-muted-foreground font-normal",
                    )}
                  />
                </div>
                <div className="relative">
                ...
                <div className="relative">
                  ...
                  <DatePicker
                    ...
                    inputClassName={cn(
                      "w-full pl-10 pr-4 h-16 rounded-[16px] justify-start text-left text-base font-bold transition-all bg-[#F1F3F6] dark:bg-[rgba(255,255,255,0.05)] border-2 border-transparent focus:border-primary/50 focus:bg-white dark:focus:bg-[rgba(255,255,255,0.1)] focus:shadow-[0_0_15px_rgba(var(--primary),0.1)]",
                      !dropOffDate && "text-muted-foreground font-normal",
                    )}
                  />
                </div>
                <div className="relative">
            ...
            <div className="flex justify-end mt-2">
              <Button
                type="submit"
                className="h-14 w-full md:w-auto px-12 md:px-16 font-black tracking-[0.1em] text-sm uppercase rounded-[14px] transition-all duration-300 bg-black text-white hover:bg-black/90 dark:bg-gradient-to-br dark:from-white dark:to-gray-300 dark:text-black dark:hover:from-white dark:hover:to-white shadow-[0_10px_20px_rgba(0,0,0,0.1)] dark:shadow-[0_10px_30px_rgba(255,255,255,0.1)] hover:shadow-xl dark:hover:shadow-white/20 hover:scale-[1.02]"
              >
                Search Cars
              </Button>
            </div>
      ...
      <div className="container mx-auto max-w-6xl px-4 py-8 flex flex-col lg:flex-row gap-8">
        ...
        {/* Sidebar Filters */}
        <aside
          className={`fixed inset-0 z-50 bg-background lg:bg-transparent lg:static lg:block lg:w-72 shrink-0 ${showMobileFilters ? "block overflow-y-auto" : "hidden"}`}
        >
          <div className="p-4 lg:p-0 sticky top-24">
            ...
            <div className="bg-card border rounded-2xl p-5 shadow-sm mb-6 hidden lg:block">
              <h3 className="text-[10px] font-black uppercase tracking-widest text-muted-foreground border-b pb-2 mb-3">
                Rental Summary
              </h3>
              ...
              <div className="flex justify-between items-center text-xs text-muted-foreground mt-1">
                <span>Drop-off</span>
                <span>
                  {dropOffDate ? dropOffDate.toLocaleDateString() : "N/A"}
                </span>
              </div>
            </div>
            ...
            <div className="bg-card border rounded-2xl p-5 shadow-sm space-y-6">
              ...
              <div className="border-t pt-4">
                ...
                <div className="space-y-2">
                  {["Economy", "Sedan", "SUV", "Luxury", "Convertible"].map(
                    (t) => (
                      <label
                        key={t}
                      ...
                      >
                        <div
                          className={`w-5 h-5 rounded flex items-center justify-center border-2 transition-colors ${selectedTypes.includes(t) ? "bg-primary border-primary" : "border-muted-foreground/30 group-hover:border-primary/50"}`}
                        >
            ...
            <div className="mt-6 lg:hidden">
              <Button
                className="w-full font-black uppercase tracking-widest h-12 rounded-xl"
                onClick={() => setShowMobileFilters(false)}
              >
          ...
          {error ? (
            ...
            <div className="text-center p-16 bg-card rounded-3xl border border-dashed">
              ...
              <p className="text-muted-foreground font-medium">
                Try adjusting your filters or changing dates to find more
                options.
              </p>
            </div>
          ) : (
            <div className="space-y-4">
              <AnimatePresence mode="popLayout">
                {filteredCars.map((car, index) => {
                  ...
                  const totalPrice = calculateCarTotalPrice(
                    car.pricePerDay,
                    durationDays,
                  );
                      ...
                      <div className="flex-1 p-5 md:p-6 flex flex-col justify-between min-w-0">
                        <div>
                          <div className="flex justify-between items-start gap-4">
                            <div>
                              <Badge
                                variant="outline"
                                className="mb-2 bg-primary/5 text-[9px] font-black uppercase tracking-widest"
                              >
                                {car.type}
                              </Badge>
                              <h3 className="text-2xl font-black tracking-tighter uppercase italic leading-none text-foreground">
                                {car.brand}{" "}
                        ...
                        <div className="mt-6 flex flex-col md:flex-row md:items-end justify-between gap-4 border-t pt-4">
                          <div className="flex items-center gap-2 text-muted-foreground text-xs font-bold uppercase tracking-widest">
                            <MapPin size={14} className="text-primary" /> Pick
                            up at Location
                          </div>
                          <div className="text-right flex flex-row md:flex-col justify-between md:justify-end items-center md:items-end gap-2 md:gap-px">
                            <div className="flex flex-col md:items-end">
                              <span className="text-[10px] uppercase font-black tracking-widest text-muted-foreground mb-0.5">
                                Total for {durationDays}{" "}
                            ...
                            <Button
                              className="h-12 md:h-10 px-6 rounded-xl font-black uppercase tracking-widest text-[10px] md:mt-2 shadow-lg shadow-primary/20"
                              onClick={() =>
                                navigate(
                                  `/checkout/car/${car._id}?pickup=${pickUpDate ? pickUpDate.toISOString().split("T")[0] : ""}&dropoff=${dropOffDate ? dropOffDate.toISOString().split("T")[0] : ""}&pickupTime=${pickUpTime || ""}&dropoffTime=${dropOffTime || ""}`,
                                  {
                                    state: {
                                      bookingData: {
                                        type: "car",
