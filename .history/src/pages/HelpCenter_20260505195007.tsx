...
export default function HelpCenter() {
  const categories = [
    ...
    },
    {
      ...
      desc: "How to manage, cancel or change your reservations.",
    },
    {
      icon: LifeBuoy,
      title: "Safety & Security",
      desc: "How we protect your data and ensure safe travel.",
    },
    {
      icon: Mail,
      title: "Contact Support",
      desc: "Get in touch with our expert travel concierge.",
    },
  ];
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <div className="max-w-2xl mx-auto relative group">
              ...
              />
              <Button className="absolute right-3 top-1/2 -translate-y-1/2 h-14 px-8 rounded-full font-black uppercase tracking-widest text-xs shadow-xl">
                Search
              </Button>
            </div>
          </motion.div>
          ...
          <div className="mt-24 grid grid-cols-1 lg:grid-cols-3 gap-12">
              ...
              {[
                {
                  ...
                  a: "You can cancel your booking through the 'My Bookings' section in your account. Refund eligibility depends on the specific airline or hotel policy mentioned during checkout.",
                },
                {
                  q: "Can I change my flight dates?",
                  a: "Most airlines allow date changes with a fee. Contact our support team or use the automated 'Reschedule' button in your booking details.",
                },
                {
                  q: "What should I do if my flight is delayed?",
                  a: "SkyWay provides real-time alerts. If a delay exceeds 3 hours, you may be eligible for compensation under SkyWay Platinum Shield.",
                },
              ].map((faq, i) => (
                <div
                  key={i}
                  className="border-b border-border pb-8 last:border-0 hover:pl-4 transition-all group"
                >
                  <h4 className="text-xl font-black uppercase italic tracking-tighter mb-4 group-hover:text-primary transition-colors">
                    {faq.q}
                  </h4>
            ...
            <div className="space-y-8">
              <div className="p-10 bg-primary/5 rounded-[40px] border border-primary/20">
                ...
                {success ? (
                  <div className="p-8 bg-green-500/10 border border-green-500/20 rounded-[30px] text-center space-y-4">
                    ...
                    <p className="text-sm text-green-700 font-medium italic">
                      Our travel concierge will contact you within 2-4 hours.
                    </p>
                    <Button
                      variant="outline"
                  ...
                  <form onSubmit={handleContactSubmit} className="space-y-4">
                    ...
                    <textarea
                      ...
                      className="w-full min-h-[120px] p-4 rounded-2xl border border-input bg-background focus:ring-2 focus:ring-primary outline-none transition-all placeholder:text-muted-foreground italic text-sm"
                    ...
                    <Button
                      type="submit"
                      className="w-full h-14 rounded-full font-black uppercase tracking-widest text-xs italic"
                ...
                <div className="mt-12 space-y-6 pt-8 border-t border-primary/10">
