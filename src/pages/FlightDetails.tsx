              ...
              <Card className="rounded-[40px] border-none shadow-xl bg-card p-10 space-y-8">
                <div className="flex items-center gap-8">
                  <div className="w-14 h-14 bg-black/5 rounded-2xl flex items-center justify-center p-3">
                    {flight.airlineLogo ? (
                      <SafeImage src={flight.airlineLogo} alt={flight.airline} className="max-w-full max-h-full object-contain" />
                    ) : (
                      <span className="text-2xl font-black italic opacity-30">{ flight.airline?.substring(0, 2) || flight.airline?.substring(0, 2) || 'FL' }</span>
                    )}
                  </div>
                  <div>
             ...
             <CardContent className="p-12 space-y-8">
                {(() => {
                   ...
                   return (
                     <>
                        <div>
                          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-muted-foreground italic mb-6 block opacity-60">Fare Breakdown</span>
                          ...
                          <div className="flex items-baseline justify-between pt-4">
                            <span className="text-xl font-black uppercase italic">Final Total</span>
                            <p className="text-5xl font-black italic tracking-tighter leading-none text-primary">{formatPrice(pricing.total / 100)}</p>
                          </div>
                        </div>
                        ...
                        <div className="p-8 bg-muted/20 rounded-[40px] border border-border/50 space-y-6">
                          <div className="flex justify-between items-center">
                            ...
                            <span className="text-xs font-black italic uppercase">{cabinClass}</span>
                          </div>
                          <div className="flex justify-between items-center">
                            <span className="text-[10px] font-black uppercase tracking-widest text-muted-foreground italic">Trip Type</span>
                            <span className="text-xs font-black italic uppercase">{tripType}</span>
                          </div>
                          <div className="flex justify-between items-center">
